...
var AllreportsComponent = /** @class */ (function () {
    ...
    //
    // }
    function AllreportsComponent(exportWoffstoryservice // private exportProductsService: ExportProductsService
    ) {
    ...
    AllreportsComponent.prototype.openactivityrpt = function () {
        window.open(environment.birt +
            '/frameset?__report=collectoractivity_test2.rptdesign&__title=Activity Report', '_blank');
    };
