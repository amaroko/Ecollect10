...
var AccplansComponent = /** @class */ (function () {
    ...
    AccplansComponent.prototype.getplanactions = function (planid) {
        var _this = this;
        this.ecolService.getplanactions(planid).subscribe(function (resp) {
    ...
    AccplansComponent.prototype.getallplans = function () {
        var _this = this;
        this.ecolService.all_s_plans().subscribe(function (response) {
    ...
    AccplansComponent.prototype.newplan = function (form) {
        ...
        swal
            ...
            if (result.value) {
                ...
                _this.ecolService.post_s_plan(body).subscribe(function (Response) {
    ...
    AccplansComponent.prototype.addactionSubmit = function (form) {
        ...
        swal
            ...
            if (result.value) {
                // get action
                console.log(form);
                _this.ecolService.getanaction(form.planaction).subscribe(function (data) {
                    // console.log(data);
                    var body = {
                    ...
                    _this.ecolService.post_s_plan_actions(body).subscribe(function (resp) {
                        console.log(resp);
