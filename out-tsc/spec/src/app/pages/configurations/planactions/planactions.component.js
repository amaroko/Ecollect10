...
var PlanactionsComponent = /** @class */ (function () {
  ...
  PlanactionsComponent.prototype.makeRandom = function (
    lengthOfCode,
    possible
  ) {
    var text = '';
  ...
  PlanactionsComponent.prototype.saveplanaction = function (form) {
    ...
    // save to db
    this.ecolService.post_s_actions(this.model).subscribe(
      function (response) {
  ...
  PlanactionsComponent.prototype.updateaction = function (form) {
    ...
    this.model.updateby = this.username;
    // save to db
    this.ecolService.put_s_actions(this.model).subscribe(
      function (response) {
