...
@NgModule({
  declarations: [ActivityhomeComponent, NotesComponent, ActivityactionComponent, EditnoteComponent,
    DemandlettersComponent, SmsComponent, AccplanComponent, CustcontactsComponent, CollateralsComponent,
    GuarantorsComponent, FilesComponent, BulknotesComponent, PtpsComponent, WriteoffstoryComponent],
  imports: [
    PanelModule,
    CommonModule,
    NgbModule,
